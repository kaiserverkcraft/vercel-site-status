  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> kcraftnetwork </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/kaiserverkcraft/vercel-site-status",
  home: "https://www.kaialist.top/",
  email: "mailto:kcraftnetwork@095681.xyz",
};
</script>
